...
products.forEach((product) => {
  ...
  function addproduct(){
    ...
    //const vb = document.createTextNode;
    //vb = "vv"
    //myp.appendChild(vb);
    
    document.write(price.textContent);
    document.write(name.textContent)
  ...
  //document.appendChild(productDiv[i].infoDiv.button.textContent)
  //productDiv[i].infoDiv.button.onClick = myf;
  //function myf(){
   // console.log("fg");
 // }
});
